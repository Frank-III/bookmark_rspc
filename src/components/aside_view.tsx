import { Text, Alert, Aside, Center, Divider, Loader, MediaQuery } from "@mantine/core";
...
export function AsideView() {
  ...
  const LinksView = () => {
    ...
    case "loading":
      return <Center mt="lg"><Loader variant='dots'/></Center>
      break
      
    case "error":
      return error.code === 400 ?  (<Text mt="lg">Please choose a date!</Text>) :
